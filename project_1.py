...
class Calc():
    ...
    def gamma_func(self):
        self.result = False
        self.current = math.gamma_func(float(self.current_value.get()))
        self.display(self.current)
...
btn2Pi = Button(calc, text="2pi", width=6, height=2,
                ...
                bd=4, command=added_value.two_pi
...
btnsin= Button(calc,text="sinh",width=6, height=2,
                  bg='black',fg='white',
                  font=('Helvetica',20,'bold')
...
btnGamma_func = Button(calc, text="Gamma", width=6,height=2, 
                       bg='black', fg='white',
                       font=('Helvetica', 20, 'bold'),
                       bd=4, command=added_value.gamma_func
